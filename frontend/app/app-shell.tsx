...
type TabKey = 'dashboard' | 'scan' | 'findings' | 'settings';
                ...
                {nav.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={
                        'w-full text-left group flex items-center justify-between rounded-xl px-4 py-3 text-sm border transition ' +
                        (active
                    ...
                    >
                      ...
                      <span
                        className={
                          active
                            ? 'text-[rgba(94,255,169,0.95)]'
                            : 'text-zinc-500 group-hover:text-[rgba(94,255,169,0.75)]'
                        }
                      >
                        ▸
                      </span>
